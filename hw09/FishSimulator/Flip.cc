...
FlipFish::FlipFish(double x, double y, double speed, double distance, double dir, double t_rate, Population* p)
    : Fish (x, y, speed, distance, p), direction(dir), turn_rate(t_rate){
